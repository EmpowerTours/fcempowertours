...
export const EARVIN_GALLARDO_EPK: EPKMetadata = {
  ...
  artist: {
    ...
    // The music is REAL VOCALS over instrumentals bought from human producers. This bio used to
    // credit the machine for both the writing and the production — a false claim about a working
    // artist, and the kind that has to be retracted rather than edited once a press kit or a DSP
    // disclosure carries it. AI is used for the videos and the cover art, and the video credit
    // below still says so, accurately. tools/verify-catalogue-claims.ts is what keeps it out.
    bio: "Born in Chilpancingo, Mexico and raised in Queens, New York, Earvin Gallardo is an artist and technologist working at the intersection of independent music and blockchain. With tracks minted on EmpowerTours on Monad, Earvin pioneers a new paradigm of music ownership where every stream, sale, and royalty payment is verifiable on-chain. His eclectic style blends alternative hip-hop with Latin influences and experimental production, shaped by NYC's diverse cultural landscape. Featured on Phoenix FM's Rising Stars, covered by Jamsphere and Soundlooks.",
    genre: ["Alternative Hip-Hop", "Electronic", "Latin", "Experimental"],
  ...
  press: [
    {
      outlet: "Jamsphere",
      title:
        "Earvin Gallardo - Love Hate Remorse - a creative with the ability to fully execute his own vision",
      ...
      date: "2021-11-12",
      excerpt:
        "Earvin Gallardo is an NYC-based underground rapper demonstrating versatility across multiple tracks, blending hypnotic alternative hip-hop with Latin influences and poetic lyricism that sets him apart from his contemporaries.",
    },
    {
      outlet: "Phoenix FM",
      ...
      date: "2021-11-09",
      excerpt:
        "Featured on Phoenix FM's Rising Stars show with 'Yummy Brujerias.' Growing up in NYC's diverse cultural landscape shaped his eclectic musical taste, aiming to create music that unites people globally.",
    },
    {
      outlet: "Soundlooks",
      title:
        "Earvin Gallardo - Love Hate Remorse - his tracks have an alternative twist, which takes him out of the ordinary lane",
      ...
      date: "2021-11-12",
      excerpt:
        "Earvin Gallardo distinguishes himself through alternative hip-hop production and introspective lyricism that sets him apart from mainstream contemporaries.",
    },
  ],
  booking: {
