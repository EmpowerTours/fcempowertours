...
SAFE_OWNER_PRIVATE_KEY=your_safe_owner_private_key_here
...
NEXT_PUBLIC_SAFE_ACCOUNT=your_safe_account_address
BOT_SMART_ACCOUNT_ADDRESS=your_bot_smart_account
NEXT_PUBLIC_ENTRYPOINT_ADDRESS=0x0000000071727De22E5E9d8BAf0edAc6f37da032
NEXT_PUBLIC_PIMLICO_API_KEY=your_pimlico_api_key
NEXT_PUBLIC_PIMLICO_BUNDLER_URL=https://api.pimlico.io/v2/10143/rpc?apikey=YOUR_KEY

# Farcaster & Casting
NEXT_PUBLIC_NEYNAR_API_KEY=your_neynar_api_key
BOT_FID=your_bot_fid
BOT_SIGNER_UUID=your_signer_uuid
BOT_USERNAME=your_bot_username
NEYNAR_WALLET_ID=your_neynar_wallet
...
# Envio Indexer
NEXT_PUBLIC_ENVIO_ENDPOINT=your_envio_endpoint
...
# App
NEXT_PUBLIC_URL=your_production_url
```
