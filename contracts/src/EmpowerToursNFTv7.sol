...
contract EmpowerToursNFTv7 is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    IERC20 public wmonToken;  // For payments (license purchases)
    ...
    constructor(address _treasury, address _wmonToken, address _toursToken) ERC721("EmpowerTours NFT", "ETNFT") Ownable(msg.sender) {
    ...
    // ============================================
    // ✅ NEW v7: Delegated Burning Functions
    // ============================================

    /**
     * @notice Set an address as an authorized burner (can burn on behalf of users)
     * @param burner The address to authorize/unauthorize
    ...
    /**
     * @notice Burn an NFT on behalf of the owner (for authorized burners only)
     * @param owner The owner of the NFT
