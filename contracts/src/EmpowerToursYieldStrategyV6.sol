...
/**
 * @title EmpowerToursYieldStrategyV6
 * @notice V6 = Accepts MON directly, no TokenSwap dependency for staking
 * @dev Users deposit MON → Kintsu, receive MON back on unstake
 * @dev Maintains V5 security fixes: per-position yield tracking, owner recovery, no NFT transfer
 */
contract EmpowerToursYieldStrategyV6 is Ownable, ReentrancyGuard {
