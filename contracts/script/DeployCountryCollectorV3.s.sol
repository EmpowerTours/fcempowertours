...
import "../contracts/CountryCollectorV3.sol";

/**
 * @notice Deploy CountryCollectorV3 with Switchboard randomness
 *
 * === Monad Testnet ===
 ...
 */
contract DeployCountryCollectorV3 is Script {
    ...
    function run() external {
        ...
        CountryCollectorV3 game = new CountryCollectorV3(
            switchboard,
            toursToken,
            keeper,
            resolver
