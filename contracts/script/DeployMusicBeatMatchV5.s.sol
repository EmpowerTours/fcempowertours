...
import "../contracts/MusicBeatMatchV5.sol";

/**
 * @notice Deploy MusicBeatMatchV5 with Switchboard updateFee payment support
 *
 * === Monad Testnet ===
 ...
 */
contract DeployMusicBeatMatchV5 is Script {
    ...
    function run() external {
        ...
        MusicBeatMatchV5 game = new MusicBeatMatchV5(
            switchboard,
            toursToken,
            keeper,
            resolver
        ...
        console.log("\n=== Deployed! ===");
        console.log("MusicBeatMatchV5:", address(game));
        ...
        console.log("\n=== Add to .env ===");
        console.log("NEXT_PUBLIC_MUSIC_BEAT_MATCH_ADDRESS=", address(game));
