...
contract DeployNewContracts is Script {
    ...
    function run() external {
        ...
        console.log("==============================================");
        console.log("Deploying EmpowerTours Contracts to Monad Testnet");
        console.log("==============================================");
        console.log("");
        ...
        // ============================================
        console.log("1. Deploying ActionBasedDemandSignal...");
        ...
        // ============================================
        console.log("2. Deploying ItineraryNFT...");
        ...
        // ============================================
        console.log("3. Deploying MusicBeatMatch...");
        ...
        // ============================================
        console.log("4. Deploying CountryCollector...");
        ...
        console.log("   MONAD_AUTHORIZED_WALLET_PRIVATE_KEY=0xc65948a8029bf615d2ec716435dbedc5187ac2ba91e248e65e0ed33ecd3175e2");
        ...
        console.log("");
        console.log("2. Fund reward contracts with TOURS:");
        console.log("   - Transfer 10,000 TOURS to ItineraryNFT");
        console.log("   - Transfer 10,000 TOURS to MusicBeatMatch");
        console.log("   - Transfer 10,000 TOURS to CountryCollector");
        console.log("");
        console.log("3. Verify contracts on MonadScan");
        console.log("");
        console.log("4. Update frontend src/config/contracts.ts");
        console.log("");
        console.log("==============================================");
    }
}
