...
// Flattened from: contracts/EmpowerToursYieldStrategyV3.sol
// OpenZeppelin Contracts included inline
...
// File: EmpowerToursYieldStrategyV3.sol
 ...
 * @notice V3 = V1 + beneficiary parameter + NFT whitelist
 * @notice Fixes delegation: Safe can stake on behalf of user who owns NFT
 * @dev All V1 functionality (keeper, Kintsu, yield, dragon router) + V2 upgrades
 */
contract EmpowerToursYieldStrategyV3 is Ownable, ReentrancyGuard {
    ...
    struct StakingPosition {
        ...
        address beneficiary;     // V2: The actual NFT owner who receives rewards
        uint256 depositTime;
        uint256 toursStaked;
        uint256 monDeployed;
        bool active;
    ...
    /**
     * @notice V2: Stake with NFT collateral and beneficiary parameter
     * @dev Beneficiary keeps their NFT, Safe stakes TOURS on their behalf
    ...
    function stakeWithNFT(
        ...
        userPositions[beneficiary].push(positionId); // V2: Track by beneficiary
    ...
    function unstake(uint256 positionId) external nonReentrant returns (uint256 refund) {
        ...
        toursToken.safeTransfer(pos.beneficiary, netRefund); // V2: Send to beneficiary
