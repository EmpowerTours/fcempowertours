 ...
 */
contract PersonalAssistantV1 is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Traveler creates service request
     */
    function createServiceRequest(
        ...
        address assistant = travelerToAssistant[msg.sender];
        ...
        emit ServiceRequestCreated(requestId, msg.sender, assistant, serviceType, suggestedPrice);
