      ...
      img.onload = () => {
        ...
        canvas.toBlob(
          (blob) => {
            ...
            console.log(
              `🖼️ Image resized: ${(file.size / 1024).toFixed(0)}KB → ${(resizedFile.size / 1024).toFixed(0)}KB (${width}x${height})`,
            );
            resolve(resizedFile);
          },
          "image/jpeg",
  ...
  const uploadAndMint = async () => {
    ...
    try {
      ...
      if (!previewFile && fullFile && nftType === "music") {
        ...
        console.log(
          `Trimmed preview created: ${(actualPreviewFile.size / 1024).toFixed(0)}KB`,
        );
      }
      ...
      if (isCollectorEdition) {
        ...
        console.log(
          "Executing collector mint command with cover URL:",
          coverUrl,
        );
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Choose music or art, upload files, and mint on Monad
              </p>
                            ...
                            {previewFile ? (
                              ...
                              <div className="py-8">
                                ...
                                <p className="text-xs text-purple-600 font-medium mt-2">
                                  💡 Or skip this - we'll auto-generate a 3s
                                  preview from your full track!
                                </p>
                              </div>
                            )}
                          </div>
                      ...
                      <div className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl border-2 border-yellow-300">
                        ...
                        <div className="space-y-4">
                          ...
                          <p className="text-xs text-gray-500 text-center">
                            This 3-second clip will be auto-generated as your
                            preview
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-200">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-amber-700 mt-2">
                          Your cover art will be automatically enhanced by
                          Gemini AI with premium collector edition effects —
                          golden borders, holographic textures, and a limited
                          edition badge.
                        </p>
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  {!isCollectorEdition && (
                    <div className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border-2 border-green-200">
                      ...
                      <p className="text-sm text-gray-600 mb-4">
                        How much will fans pay to own this NFT?
                      </p>
                      ...
                      <div className="relative">
                        ...
                        />
                        <span className="absolute right-6 top-4.5 text-gray-600 font-bold pointer-events-none">
                          WMON
                        </span>
                      </div>
                      <p className="text-xs text-gray-500 mt-2">
                        Min: 35 | Max: 100,000,000 WMON
                      </p>
                    </div>
                  )}
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            />
                            <span className="absolute right-6 top-3.5 text-gray-600 font-bold pointer-events-none">
                              WMON
                            </span>
                          </div>
                          <p className="text-xs text-gray-500 mt-1">
                            Min: 35 WMON — fans can always buy standard copies
                            at this price
                          </p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-2 text-gray-700">
                          ...
                          <p>
                            <strong>Standard Price:</strong> {price} WMON per
                            license
                          </p>
                          <p>
                    ...
                    {isCollectorEdition && (
                      <div className="mt-6 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border-2 border-amber-200">
                        ...
                        <div className="mt-3 p-2 bg-white rounded-lg text-xs text-gray-600">
                          Standard: {price} WMON (unlimited) | Collector:{" "}
                          {collectorPrice} WMON ({maxEditions} editions)
                          {nftType === "music" ? " | Fee: 5 WMON" : ""}
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-xl border-2 border-blue-200">
              ...
              <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                <li>
                  Set your price in WMON tokens (what fans pay to own your NFT)
                </li>
