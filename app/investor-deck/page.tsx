  ...
  const slides = [
    ...
    <div key="1" className="slide center">
      ...
      <p className="subtitle">
        On-Chain Settlement Infrastructure for the Creator Economy
      </p>
      <div className="tags">
    ...
    <div key="2" className="slide">
      ...
      <p className="intro">
        EmpowerTours is a <strong>blockchain settlement layer</strong> for the
        $150B creator economy. All revenue splits enforced on-chain via smart
        contracts.
      </p>
      <div className="grid-2">
        <div className="card card-accent">
          ...
          <ul>
            ...
            <li>
              We pay{" "}
              <span className="highlight">90% in the same transaction</span>
            </li>
            <li>Zero counterparty risk - all on-chain</li>
            <li>Artist keeps the master; licences are transferable ERC-721</li>
          </ul>
        </div>
        <div className="stats-grid">
          ...
          <div className="card">
            ...
            <div className="stat-label">TPS (Monad)</div>
          </div>
        </div>
      </div>
    </div>,
        ...
        <div className="card">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>YouTube</td>
                <td className="yellow">45%</td>
                <td>Monthly</td>
              </tr>
              <tr>
                <td>Apple Music</td>
                <td className="yellow">52%</td>
                <td>Monthly</td>
              </tr>
              <tr>
                <td className="cyan bold">EmpowerTours</td>
    ...
    <div key="4" className="slide">
      ...
      <p className="intro">
        Every revenue split enforced by smart contracts. Instant settlement.
      ...
      <div className="grid-3">
        <div className="card card-accent">
          ...
          <div className="highlight-box green">
            Fan buys → Artist paid → Same block
          </div>
        </div>
        <div className="card card-accent">
          <h3 className="purple">On-chain Settlement</h3>
          <p>
            Every split is enforced by the contract, not by policy. The artist
            is paid in the same transaction as the buyer, with no platform
            custody in between.
          </p>
          <div className="highlight-box purple">
            90% to artist • instant • non-custodial
          </div>
        </div>
        <div className="card card-accent">
          <h3>Account Abstraction</h3>
          <p>
            100% gasless transactions via ERC-4337. Users never see approve
            popups.
          </p>
    ...
    <div key="5" className="slide">
      ...
      <div className="grid-2 align-center">
        <div className="screenshot-container">
          <img
            src="/investor-deck/oracle-final.png"
            alt="EmpowerTours App"
        ...
        <div>
          ...
          <ul>
            <li>
              <strong>AI Oracle</strong> - Natural language interface
            </li>
            <li>
              <strong>Music NFTs</strong> - Mint, license, trade on-chain
            </li>
            <li>
              <strong>Live Radio</strong> - Decentralized jukebox + tips
            </li>
            <li>
              <strong>Passport NFTs</strong> - GPS-verified collectibles
            </li>
            <li>
              <strong>Direct Resale</strong> - Sell a licence by sending a link
            </li>
            <li>
              <strong>EPK Registry</strong> - AI press kits + booking
            </li>
          </ul>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>Subscriptions</td>
                <td>70/20/10</td>
                <td>Monthly pool (20% → listeners)</td>
              </tr>
              <tr>
                <td>EPK Bookings</td>
                <td>Escrow</td>
        ...
        <div className="card card-accent">
          ...
          <div className="economics">
            <div className="econ-row">
              ...
              <span className="highlight">3,000,000 WMON</span>
            </div>
            <div className="econ-row">
              <span>Artist Pool (70%)</span>
              <span>2,100,000 WMON</span>
            </div>
            <div className="econ-row">
              <span>Listener Pool (20%) — active radio listeners</span>
              <span>600,000 WMON</span>
            </div>
            <div className="econ-row last">
              <span>Treasury (10%)</span>
              <span className="green">300,000 WMON</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div key="7" className="slide">
      ...
      <p className="intro">
        20 verified contracts on Monad Mainnet. All open-source.
      </p>
      <div className="card">
        <table className="contracts-table">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <strong>LiveRadioV3</strong>
              </td>
              <td>Radio queue, tips, voice notes</td>
              <td className="mono">0x042E...00fd</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <strong>ListenerRewardPool</strong>
              </td>
              <td>20% reserve → active listener WMON</td>
              <td className="mono">0x98c0...51A7</td>
            </tr>
            <tr>
              <td>
                <strong>PlayOracleV3</strong>
              </td>
              <td>On-chain play tracking &amp; anti-spam</td>
              <td className="mono">0xe210...DCEf</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <strong>VenueRegistry</strong>
              </td>
              <td>Venue registration + TOURS mining</td>
              <td className="mono">0x7326...43B5</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <strong>EPKRegistryV2</strong>
              </td>
              <td>EPK metadata + booking escrow</td>
              <td className="mono">0x232D...621D</td>
            </tr>
            <tr>
              <td>
                <strong>ToursTokenV2</strong>
              </td>
              <td>ERC-20 governance + reward token</td>
              <td className="mono">0xf61F...f74f</td>
            </tr>
            <tr>
              <td>
                <strong>WMON</strong>
              </td>
              <td>Wrapped Monad (payment token)</td>
              <td className="mono">0x3bd3...433A</td>
            </tr>
            <tr>
              <td>
                <strong>PassportNFTV3</strong>
              </td>
              <td>Travel passport NFTs (195 countries)</td>
              <td className="mono">0x9312...1851</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <strong>DeploymentNFT</strong>
              </td>
              <td>Provenance NFTs for contracts</td>
              <td className="mono">0xfA00...A586</td>
            </tr>
            <tr>
              <td>
                <strong>EmpowerToursDevStudio</strong>
              </td>
              <td>AI contract generation credits</td>
              <td className="mono">0xEC27...d880</td>
            </tr>
            <tr>
              <td>
                <strong>Platform Safe</strong>
              </td>
              <td>Treasury &amp; operations</td>
              <td className="mono">0xf3b9...25bA</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div key="9" className="slide">
      ...
      <div className="grid-3">
        <div className="card card-accent">
          ...
          <p>
            Deposit into Platform Safe. Structured product exposure to platform
            revenue.
          </p>
        ...
        <div className="card card-accent">
          ...
          <p>
            Direct participation in platform&apos;s 30% commission across all
            streams.
          </p>
          <ul className="small-list">
      ...
      <div className="cta-box">
        <strong>Why Further Asset Management?</strong> Pioneering financial
        infrastructure + Digital assets + Structured products = Perfect
        alignment
      </div>
    </div>,
    ...
    <div key="10" className="slide">
      ...
      <p className="footnote">
        Assumptions: 50% YoY growth | Avg WMON = $10 USD | 30% platform
        commission
      </p>
    </div>,
    ...
    <div key="11" className="slide center">
      ...
      <div className="grid-2 qr-grid">
        <div className="card card-accent">
          ...
          <div className="qr-row">
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://farcaster.xyz/miniapps/83hgtZau7TNB/empowertours"
              alt="QR"
              className="qr"
            />
            <div>
      ...
      <div className="contact-footer">
        <p>
          <strong>Monad Mainnet</strong> (Chain ID: 143)
        </p>
