...
const PASSPORT_NEXT_PUBLIC_NFT_ADDRESS = (process.env.NEXT_PUBLIC_PASSPORT_NFT_V2 || process.env.NEXT_PUBLIC_PASSPORT || '0x04a8983587B79cd0a4927AE71040caf3baA613f1') as `0x${string}`;
