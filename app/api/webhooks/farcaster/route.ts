...
const PASSPORT_NEXT_PUBLIC_NFT_ADDRESS = (process.env.NEXT_PUBLIC_PASSPORT_NFT || process.env.NEXT_PUBLIC_PASSPORT || '0xCDdE80E0cf16b31e7Ad7D83dD012d33b328f9E4f') as `0x${string}`;
