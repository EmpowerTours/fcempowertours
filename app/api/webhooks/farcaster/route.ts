...
const PASSPORT_NEXT_PUBLIC_NFT_ADDRESS = (process.env.NEXT_PUBLIC_PASSPORT_NFT || process.env.NEXT_PUBLIC_PASSPORT || '0xeB6D46684849D292FFf0D27221ABEB293633c1ba') as `0x${string}`;
