...
export async function POST(req: NextRequest) {
  try {
    ...
    const YIELD_STRATEGY = (process.env.NEXT_PUBLIC_YIELD_STRATEGY || '0x2804add55b205Ce5930D7807Ad6183D8f3345974') as Address;
...
@empowertours`;
      ...
      case 'stake_tours':
        ...
        // The V2 contract accepts a beneficiary parameter, so no NFT transfer is needed!
