...
function CountryCollectorContent() {
  ...
  const isChallengeActive = challenge && (challenge as any).active && !((challenge as any).finalized) && (challenge as any).endTime > BigInt(Math.floor(Date.now() / 1000));
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!isChallengeActive && (
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20 text-center mb-8">
            <p className="text-white text-2xl mb-4">🌍 Ready to explore?</p>
            <p className="text-teal-200 mb-6">Start a new weekly challenge and collect country badges!</p>
            ...
            <div className="pt-2">
              <button
                ...
                className="bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-bold px-10 py-4 rounded-xl transition-all transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed shadow-xl text-lg"
              >
